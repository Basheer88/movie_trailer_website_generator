...
black_panther = media.Movie("Black Panther",
                            "T'Challa is crowned king of Wakanda following his father's death, but his sovereignty is soon challenged by a new adversary who plans to abandon the country's isolationist policies and begin a global revolution.",  # noqa
...
thor_ragnarok = media.Movie("Thor Ragnarok",
                            "Thor must escape the alien planet Sakaar in time to save Asgard from Hela and the impending Ragnarok",  # noqa
...
pacific_rim_u = media.Movie("Pacific Rim Uprising",
                            "In 2035, the plot follows humanity again fighting Kaiju, the giant monsters set on destroying the world.",  # noqa
...
gringo = media.Movie("Gringo",
                     "A mild-mannered businessman sent to Mexico to deliver an experimental marijuana pill. When he is kidnapped by the drug cartel he must escape alongside a hired mercenary.",  # noqa
...
terminator_6 = media.Movie("Terminator 6",
                           "I will be back. he said, and so he will, for the sixth time. The timey-wimey cyborg franchise is marching off into the future with no signs of slowing down",  # noqa
